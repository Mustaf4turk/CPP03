...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/17 06:04:20 by rakman            #+#    #+#             */
/*   Updated: 2026/02/17 11:49:20 by rakman           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//extra
void ClapTrap::print_hit_points() const
{
	std::cout << "ClapTrap " << this->name << " has " << this->hit_points << " HP." << std::endl;
}

void ClapTrap::print_energy_points() const
{
